...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, DC1_Pin|DC2_Pin|DC3_Pin|DC4_Pin
                          |DC5_Pin|DC6_Pin|DC7_Pin|DC8_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, LED1_Pin|LED2_Pin|LED3_Pin|LED4_Pin
                          |LED5_Pin|LED7_Pin, GPIO_PIN_SET);

  /*Configure GPIO pins : BEEP_Pin DC1_Pin DC2_Pin DC3_Pin
                           DC4_Pin DC5_Pin DC6_Pin DC7_Pin
                           DC8_Pin */
  GPIO_InitStruct.Pin = BEEP_Pin|DC1_Pin|DC2_Pin|DC3_Pin
                          |DC4_Pin|DC5_Pin|DC6_Pin|DC7_Pin
                          |DC8_Pin;
